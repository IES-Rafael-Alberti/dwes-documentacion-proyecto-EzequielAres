...
export const NotFound = () => {
  ...
  useEffect(() => {
    if (localStorage.getItem("modoOscuro") == "true") {
      ...
      require('../css/notFound/notFoundResponsive.scss');
      require('../css/desplegableNoche.scss');
    } else {
      require('../css/notFound/notFound.scss');
      require('../css/notFound/notFoundResponsive.scss');
  ...
  return (
    <main className='main'>
      <section className='notFound__main__contenedor'>
        <h1>404</h1>
        <h2>This site does not exist</h2>
      </section>

      <footer className='notFound__main__footer'>

        <section className='notFound__main__footer__contenedor1'>
          <a href='/'>Cookpedia</a>
          <div className='notFound__main__footer_contenedor1__rrss'>
        ...
        <section className='notFound__main__footer_contenedor2 desktop'>
