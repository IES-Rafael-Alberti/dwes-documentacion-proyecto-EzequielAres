  ...
  return (
    <main className='Recipes__main'>
      ...
      <section className='Recipes__main__recetas'>
        ...
        <footer className='Recipes__main__footer'>

          <section className='Recipes__main__footer__contenedor1'>

            <a href='/'>Cookpedia</a>
            <div className='Recipes__main__footer_contenedor1__rrss'>
          ...
          <section className='Recipes__main__footer_contenedor2 desktop'>
