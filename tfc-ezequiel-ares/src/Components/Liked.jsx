...
export const Liked = () => {
  ...
  return (
    <main className='Liked__main'>
      ...
      <footer className='Liked__main__footer'>
          <section className='Liked__main__footer__contenedor1'>
            <a href='/'>Cookpedia</a>
            <div className='Liked__main__footer_contenedor1__rrss'>
          ...
          <section className='Liked__main__footer_contenedor2 desktop'>
