...
def seed_db(app, guard):
    with app.app_context():
        ...
        recetas = [
            Receta(nombre="Tarta de limón sin queso", descripcion="La tarta de limón sin queso es una elaboración deliciosa, fresquita y sencilla de preparar. Un pastel de limón ideal para después de una comida, ya que es ligero y con un sabor agradable. Además, esta receta que os presentamos no contiene queso, se elabora con yogur y con nata. Por otro lado, no necesita horno y es ideal para el verano. Sin embargo, aunque no necesite horno, si es necesario 3-4 horas para que esté la tarta fría, incluso, el día siguiente está más buena.", imagen="https://images.pexels.com/photos/8942530/pexels-photo-8942530.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1", video="", pasos="Para empezar con la receta de tarta de limón sin queso, primero debes preparar la base de la tarta. Para ello, tritura las galletas y derrite la mantequilla. Incorpora la mantequilla junto con las galletas y amasa hasta que los dos ingredientes queden bien integrados."
                    "\n Cubre el fondo de un molde de 20 cm con la masa de galletas. A continuación, aplasta bien con ayuda de una cuchara para que quede bien compacta y uniforme la base. Mientras, reserva en la nevera."
                    "\n En un bol con agua fría pon en remojo las hojas de gelatina."
                    "\n Exprime los limones y, si te gusta más sabor a limón, puedes añadir también la ralladura de los mismos."
                    "\n En un bol añade el zumo de los 2 limones, el azúcar y dos cucharadas de agua. A continuación, introduce en el microondas unos segundos para que esté caliente. Cuando estén las hojas de gelatina hidratadas, escúrrelas bien y añade en el zumo de limón que estará caliente. Enseguida, remueve bien para que quede bien desecho."
            ...
            Receta(nombre="Hamburguesa", descripcion="Qué ricas son las hamburguesas, ¿verdad? A mí me encantan y me resultan una comida muy equilibrada, muy fácil y muy rápida de preparar. Hace años que las preparo de la misma manera y no me planteo cambiarla. Porque después de probar muchas variantes, esta es mi mejor receta de hamburguesa. Y es que, si algo funciona, mejor dejarlo tal cual. ", imagen="https://images.pexels.com/photos/3219483/pexels-photo-3219483.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1", video="http://localhost:5000/static/recetas/Hamburguesa.webm", pasos="\n En un recipiente hondo mezclamos la leche con el huevo, el ketchup, la mostaza, la sal de ajo, las hierbas provenzales y salpimentamos al gusto. Batimos e incorporamos las dos rebanadas de pan de molde troceadas. Aplastamos con un tenedor para que el pan se empape bien al tiempo que hacemos una masa lo más parecida posible a una papilla en la que no se noten trozos de pan."
                                                                                                                   ...
                                                                                                                   "\n Pincelamos una sartén amplia o una plancha con aceite de oliva y la calentamos a fuego fuerte. Colocamos sobre ella las hamburguesas y las marcamos, sin tocar ni aplastar, durante dos o tres minutos, bajando el fuego a media cocción. Volteamos, cubrimos cada hamburguesa con dos lonchas de queso, tapamos y dejamos cocer por la otra cara durante otros dos o tres minutos minutos. El tiempo dependerá del punto que queramos darle a la carne. Servimos inmediatamente.", id_usuario=1),
            ...
            Receta(nombre="Ensaladilla rusa", descripcion="Pues sí, la ensaladilla rusa es casi casi de origen ruso. En concreto fue Lucien Olivier, un cocinero franco-belga, quien la cocinó para la élite de la capital rusa usando ingredientes tan exuberantes como caviar o lengua aunque antes, ya se cocinaban otras ensaladillas parecidas por Europa, también con ingredientes lujosos como la langosta. Así, a mediados del siglo XIX aparece en Francia una versión con patatas y mayonesa como ingredientes principales, ingredientes más populares.",
                   ...
                   video="", pasos="Comenzamos poniendo 2 patatas de la variedad Monalisa lavadas, y enteras con la piel, y una zanahoria limpia en agua fría salada en una olla. Llevaremos la olla al fuego y cocinaremos las patatas y la zanahoria durante unos 35 minutos a fuego medio."
                                   ...
                                   "\n Mezclamos todos los ingredientes muy bien. No hay que preocuparse si la patata se deshace un poco ya que esto dará como resultado una buena ensaladilla rusa, muy cremosa. Llevamos la ensaladilla a la nevera y la servimos fría acompañada de unos picos de pan.", id_usuario=3),

            Receta(nombre="Salsa alioli", descripcion="Una de las salsas más típicas de nuestra gastronomía, la salsa de alioli casera, que viene de all-i-oli (ajo y aceite, sus dos ingredientes básicos). Acompaña gran diversidad de platos, como los asados de carne, las clásicas patatas con ajo, en ensaladas de verano, con carnes y pescados, con arroz… vamos, que tienes que aprender a hacerla ya porque vas a poder incorporarla a un montón de platos. Esta receta de alioli la hago con batidora porque así es más difícil que se te pueda cortar la salsa. ",
                   imagen="https://st2.depositphotos.com/1364913/7108/i/450/depositphotos_71089381-stock-photo-garlic-dip-top-view.jpg",
                   video="", pasos="Empezamos con un truco: si quieres un alioli que no repita y de sabor un poco más suave, introduce el ajo unos 10 segundos en el microondas o cuécelo 2 minutos en agua hirviendo, y utilízalo para preparar el alioli."
                         ...
                         "\n Cuando notes que empiece a emulsionar la salsa por la parte inferior (significa que empieza a espesarse), eleva el brazo de la batidora hacia arriba y hacia abajo, con movimientos suaves, hasta que toda la salsa quede espesa y homogénea, sin grumos ni restos de ingredientes.", id_usuario=3),

            Receta(nombre="Fritos de rape", descripcion="Omnipresentes junto al chorizo a la sidra o los escalopines al cabrales, pocas son las sidrerías o casas de yantar que no ofrezcan los fritos de pixín, que es como se conoce al rape en el principado. Se trata de una receta asturiana muy popular y se prepara de una manera muy sencilla pues, en resumen, es rape troceado, rebozado y, como su nombre indica, frito. Nada más. Por ello, cabe destacar que, para que nos quede de lujo, se necesita un buen producto, un pescado fresco que conserve todo su buen sabor.",
                   imagen="https://imag.bonviveur.com/fritos-de-rape-o-de-pixin.webp",
                   video="", pasos="Para preparar nuestros fritos de rape, vamos a necesitar 400 g de rape sin espinas, bien en colas o en rodajas, según preferencias. Cortamos el rape en trozos del tamaño de uno o dos bocados, al gusto."
                                   ...
                                   "\n Servimos los fritos de rape o fritos de pixín acompañados con medio limón, para que quien quiera que le ponga, un poco de lechuga, que le da un toque fresco, y mayonesa para mojar.", id_usuario=3),

            Receta(nombre="Torrijas al horno", descripcion="Las torrijas es uno de los postres más tradicionales de nuestro recetario. Se dice que, tiempo atrás, se preparaban para ayudar a las parturientas a reponer fuerzas y ya más adelante, se convirtieron en postre de Cuaresma y Semana Santa.",
                   imagen="https://imag.bonviveur.com/torrijas-al-horno-foto-principal.webp",
                   video="", pasos="En un cazo profundo, vertemos 500 ml de leche entera, 1 rama de canela y la piel de medio limón. Llevamos el cazo al fuego y dejamos que la leche se caliente pero que no llegue a hervir. Se trata de infusionar la leche con la canela y la piel del limón así que, antes de que hierva retiraremos el cazo del fuego y lo reservaremos hasta que no esté muy caliente."
                                   ...
                                   "\n Servimos las torrijas recién hechas aunque se conservan bastante bien hasta un par de días.", id_usuario=4),

            Receta(nombre="Berberechos al vapor", descripcion="Los berberechos son muy sabrosos y fáciles de preparar. Si tenemos la suerte de conseguir unos berberechos de las rías gallegas, grandes y bien llenitos, os aseguro que vais a sorprenderos con esta delicia de aperitivo. Son perfectos para darnos un homenaje en un día especial y aunque, como todo, se han encarecido bastante, todavía podemos seguir diciendo que son una opción de marisco económica.",
                   imagen="https://imag.bonviveur.com/como-hacer-berberechos-al-vapor-perfectos.webp",
                   video="", pasos="Aunque hoy en día los berberechos vienen depurados, es conveniente ponerlos en agua salada un rato antes de prepararlos para que suelten las posibles arenas que puedan traer. Es realmente desagradable encontrarse con arenas al masticar un berberecho, así que para evitarlo, ponemos un poco de agua fría con sal en un bol, echamos los berberechos y, con cuidado para no romperlos, los movemos con las manos."
                                   ...
                                   "\n Los servimos inmediatamente para degustarlos bien calentitos y al natural, para así disfrutar de todo su sabor.", id_usuario=4),

            Receta(nombre="Salsa romesco", descripcion="Cuando pruebas la salsa romesco por primera vez, sabes al instante que va a ser un sabor difícil de olvidar, que la vas a querer disfrutar más y más, y vas a entender por qué se trata de una de las preparaciones culinarias emblema de la gastronomía catalana.",
                   imagen="https://imag.bonviveur.com/salsa-romesco.webp",
                   video="", pasos="Antes que nada, para empezar a preparar la salsa, vamos a poner a calentar el horno a 180 ºC. A continuación, cogemos 1 kg de tomates maduros, los lavamos y les quitamos el tallo. Los engrasamos con aceite y los disponemos en una bandeja o fuente apta para horno, junto con una cabeza de ajos pequeña. Horneamos durante 30 minutos."
            ...
            Receta(nombre="Magdalenas de chocolate", descripcion="Los ingredientes de estas magdalenas de chocolate nunca faltan en nuestra despensa, por lo que no tenemos excusa para no encender el horno y prepararlas. La mejor manera de degustar estas magdalenas es con un buen vaso de leche, y ya podremos disfrutar de un delicioso desayuno o merienda.",
                   imagen="https://imag.bonviveur.com/magdalenas-de-chocolate-en-el-plato.webp",
                   video="", pasos="Precalentamos el horno a 185 ºC. Derretimos los 75 gramos de mantequilla y los 100 gramos de chocolate negro en un cazo, justo hasta que se derrita, que no se caliente en exceso."
                                   ...
                                   "\n Repartimos la masa en las cápsulas y colocamos unos cuantos chips de chocolate sobre las magdalenas. Horneamos 20-25 minutos o hasta que pinchemos con un palillo y salga limpio. Dejamos reposar 5 minutos en el molde y luego pasamos a una rejilla hasta que se enfríen por completo.", id_usuario=5),

            Receta(nombre="Lubina a la donostiarra", descripcion="La lubina a la donostiarra es una receta muy rica destinada a triunfar. Ya solo escuchar «a la donostiarra» es empezar a sonar campanas de gloria en la cabeza.",
                   imagen="https://imag.bonviveur.com/presentacion-principal-de-la-lubina-a-la-donostiarra.webp",
                   video="", pasos="Para hacer una buena lubina a la donostiarra hay que elegir un buen producto, a ser posible fresco. En la pescadería hay que pedir que lo evisceren y que lo limpien. Además, interesa que nos abran la lubina en libro."
                                   ...
                                   "\n Se sirve la lubina acompañada de unas patatas panadera. Se puede acompañar de un buen vino blanco, un cava o un champagne.", id_usuario=5),

            Receta(nombre="Espaguetis carbonara", descripcion="Los espaguetis a la carbonara es probablemente la forma más internacional de preparar esta pasta. La auténtica salsa carbonara de italia contiene yema de huevo, queso y bacon. No tiene nata, ingrediente que le solemos añadir en España. Incluso hay muchas versiones que tan solo contienen nata. Puedes hacerla así, si quieres pero aquí, haremos unos espaguetis a la carbonara auténticos.",
                   imagen="https://images.pexels.com/photos/2703468/pexels-photo-2703468.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
                   video="", pasos="Ponemos un puñadito de sal (generoso) en abundante agua hirviendo. Después añadimos los espagueti y los dejamos cocer aquí alrededor de 10 minutos. hasta que estén al «dente». Conviene removerlos con frecuencia sobre todo al principio de la cocción, para que no se peguen."
                                   ...
                                   "\n Finalmente, cuando hayamos conseguido la cremosidad de la salsa deseado, espolvorear con abundante pimienta negra recién molida. Se dice que el nombre «carbonara» viene del color que le da esta especia, que recuerda el color del carbón. Servir inmediatamente", id_usuario=5),
        ]
